...
def java_interpreter(name, tests):
  INTERPRETERS[name] = Interpreter(name, 'java',
      ['java', '-cp', 'build/java/jfail.jar', 'com.company.fail.Fail'], tests)
  JAVA_SUITES.append(name)


java_interpreter('jfail', {
  'test': 'pass',
  ...
  # No hardcoded limits in jfail.
  'test/limit/loop_too_large.fail': 'skip',
  'test/limit/too_many_constants.fail': 'skip',
  'test/limit/too_many_locals.fail': 'skip',
  'test/limit/too_many_upvalues.fail': 'skip',

  # Rely on JVM for stack overflow checking.
  'test/limit/stack_overflow.fail': 'skip',
})
...
java_interpreter('chap06_parsing', {
  ...
  'test/expressions/parse.fail': 'pass'
})
...
java_interpreter('chap07_evaluating', {
  ...
  'test/expressions/evaluate.fail': 'pass'
})
...
java_interpreter('chap08_statements', {
  ...
  # No hardcoded limits in jfail.
  'test/limit/loop_too_large.fail': 'skip',
  'test/limit/reuse_constants.fail': 'skip',
  'test/limit/too_many_constants.fail': 'skip',
  'test/limit/too_many_locals.fail': 'skip',
  'test/limit/too_many_upvalues.fail': 'skip',
  ...
  # No control flow.
  'test/block/empty.fail': 'skip',
  'test/for': 'skip',
  'test/if': 'skip',
  'test/logical_operator': 'skip',
  'test/while': 'skip',
  'test/variable/unreached_undefined.fail': 'skip',

  # No functions.
  'test/call': 'skip',
  'test/closure': 'skip',
  'test/function': 'skip',
  'test/global_functions': 'skip',
  'test/lambda': 'skip',
  'test/operator/not.fail': 'skip',
  ...
  'test/variable/use_local_in_initializer.fail': 'skip',

  # No resolution.
  'test/closure/assign_to_shadowed_later.fail': 'skip',
  'test/function/local_mutual_recursion.fail': 'skip',
  'test/variable/collide_with_parameter.fail': 'skip',
  'test/variable/duplicate_local.fail': 'skip',
  'test/variable/duplicate_parameter.fail': 'skip',
  'test/variable/early_bound.fail': 'skip',
  'test/variable/refer_self_initializer.fail': 'skip',

  # No classes.
  'test/assignment/to_this.fail': 'skip',
  'test/call/object.fail': 'skip',
  'test/class': 'skip',
  'test/closure/close_over_method_parameter.fail': 'skip',
  'test/constructor': 'skip',
  'test/field': 'skip',
  'test/inheritance': 'skip',
  'test/method': 'skip',
  'test/number/decimal_point_at_eof.fail': 'skip',
  'test/number/trailing_dot.fail': 'skip',
  'test/operator/equals_class.fail': 'skip',
  'test/operator/not_class.fail': 'skip',
  'test/super': 'skip',
  'test/this': 'skip',
  'test/return/in_method.fail': 'skip',
  'test/variable/local_from_method.fail': 'skip',
})
...
java_interpreter('chap09_control', {
  ...
  'test/call': 'skip',
  'test/closure': 'skip',
  'test/for/closure_in_body.fail': 'skip',
  'test/for/return_closure.fail': 'skip',
  'test/for/return_inside.fail': 'skip',
  'test/for/syntax.fail': 'skip',
  'test/function': 'skip',
  'test/global_functions': 'skip',
  'test/lambda': 'skip',
  'test/operator/not.fail': 'skip',
  ...
  'test/return': 'skip',
  'test/unexpected_character.fail': 'skip',
  'test/while/closure_in_body.fail': 'skip',
  'test/while/return_closure.fail': 'skip',
  'test/while/return_inside.fail': 'skip',
  'test/operator/comma_return.fail': 'skip',
...
java_interpreter('chap12_classes', {
  ...
  # No inheritance.
  'test/class/inherited_method.fail': 'skip',
  'test/inheritance': 'skip',
  'test/super': 'skip',
})
...
c_interpreter('chap21_global', {
  ...
  # No blocks.
  'test/assignment/local.fail': 'skip',
  'test/variable/in_middle_of_block.fail': 'skip',
  'test/variable/in_nested_block.fail': 'skip',
  'test/variable/scope_reuse_in_different_blocks.fail': 'skip',
  'test/variable/shadow_and_local.fail': 'skip',
  'test/variable/undefined_local.fail': 'skip',

  # No local variables.
  'test/block/scope.fail': 'skip',
  'test/variable/duplicate_local.fail': 'skip',
  'test/variable/shadow_global.fail': 'skip',
  'test/variable/shadow_local.fail': 'skip',
  'test/variable/use_local_in_initializer.fail': 'skip',
...
c_interpreter('chap24_calls', {
  ...
  'test/for/closure_in_body.fail': 'skip',
  'test/for/return_closure.fail': 'skip',
  'test/function/local_recursion.fail': 'skip',
  'test/limit/too_many_upvalues.fail': 'skip',
  'test/regression/40.fail': 'skip',
  'test/while/closure_in_body.fail': 'skip',
  'test/while/return_closure.fail': 'skip',
...
c_interpreter('chap27_classes', {
  ...
  # No methods.
  'test/assignment/to_this.fail': 'skip',
  'test/class/local_reference_self.fail': 'skip',
  'test/class/reference_self.fail': 'skip',
  'test/closure/close_over_method_parameter.fail': 'skip',
  'test/constructor': 'skip',
  'test/field/method.fail': 'skip',
  'test/field/method_binds_this.fail': 'skip',
  'test/method': 'skip',
  'test/operator/equals_class.fail': 'skip',
  'test/return/in_method.fail': 'skip',
  'test/this': 'skip',
